...
- const today2 = "Good~";
- console. log(today2.length);
- console. log(today2.substring(1, 4)));
<. 5
<. ood
기억할 것: 0G1o2o3d4~5 라서 위처럼 나옴

특징: index는 0에서부터 시작함
특징: java는 인덱스 over라는 개념이 없음 (파이썬은 있음)
e.g., var today2 = "Good~Goo~Goo~":
	  today2.substring(5, today2.length): <!--length는 전체길이를 생각해--> <!--substring은 
	<.Goo~Goo~

	// 2. 문자열.slice(시작 인덱스, 끝 인덱스)
- const today2 = "Good~";
- console.log(today2.slice(1, 5));
- console.log(today2.slice(1));
- console.log(today2.slice(-4));
<. ood~
<. ood~
<. ood~
  G(-4)o(-3)o(-2)d(-1)~(0)
...
- var a = "가나다가나다";
- a.split('나다') <!--split은 '생략'이라고 표현-->
<. (4) ['가', '가', ''] <!--[]는 배열이라고 한다. 그 안의 위치는 index라고 한다-->

- var a = "가나다가나다가나다";
- var b = a.split(''); <!--이 구분자는 문자 하나를 기준으로 한 것이다-->
<.(9) ['가', '나', '다', '가', '나', '다', '가', '나', '다']
