	...
	<main class="home">
		<div class="feature-card">
			<a href="movie.html">
				...
				<!-- <img scr="https://i.pinimg.com/736x/e5/5c/89/e55c89b93dce3c74f3beccfd97c03241.jpg" alt="Movie Poster" class="featured-img"/> -->
			<div class="detail">
				<h3>The Fall</h3>
		...
		<form action="#" class="search-box">
			<input type="text" placeholder="Search for the Movie Title." />
